...
const Navbar = () => {
  return (
    <>
      ...
      {/* <ul className='block sm:hidden bg-[#7843E9] w-[10vw] h-[30vh] text-3xl flex flex-col justify-around items-center fixed top-[20%] left-3 z-10'>
